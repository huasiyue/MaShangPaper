...
![改进检测模型整体流程图|width=14cm|align=center](./test_paper_assets/model_pipeline.png)
...
![检测系统总体架构图|width=14cm|align=center](./test_paper_assets/system_architecture.png)
...
![胃镜息肉检测结果示意图|width=13cm|align=center](./test_paper_assets/detection_result.png)
